...
2. During verification process in the evaluation stage, you can `scancel` the slurm task in the queue if necessary to release the compute nodes resources, especially when you `squeue` and find that the task has not started running.
