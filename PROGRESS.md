...
1. **Clustering of Lexical Units that are Filtered out by POS and Core FEs**: I have applied Affinity Propagation clustering technique on the LU embeddings. Result clusters of a few filtered lexical units can be seen [here](https://github.com/yongzx/GSoC-2019-FrameNet/blob/master/images/viz_clustered_LUs.png).
